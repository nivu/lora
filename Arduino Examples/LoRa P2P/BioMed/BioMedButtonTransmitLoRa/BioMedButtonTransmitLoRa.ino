/*******************************************
Program for Bio Medical Appication (Blood Pressure, IR Body Temperature, Weight Sensors)
And Transmit through LoRa Radio
Code Written by Navaneeth Malingan (www.nivu.me)
https://github.com/navneetnivu07
...
// RN2483
SoftwareSerial loraSerial (9, 10); //rx 9 tx 10
...
void setup() {
  pinMode(interruptPin, INPUT_PULLUP); // DIG2 Arduino Uno
