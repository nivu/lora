...
DR5 SF7
  */
  ...
  // Keys Node ebcf
  const char *devAddr = "00ceddb4";
  const char *nwkSKey = "9b875de785c7e5f86ec756557b819d85";
  const char *appSKey = "945fd373e2071c10f719d7c573b7173a";
...
void loop(){
 ...
 for(int j = 0; j <= 15; j++) {
    ...
    for(int i = 1; i <= 20; i++) {
        ...
        String data = "A0" + String(j) + String("D") + String(i);
