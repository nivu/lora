...
void initialize_radio()
{
   ...
   */
// Keys Node 9
  const char *devAddr = "0ed6a29d";
  const char *nwkSKey = "a81ebd4bea2d560a71d8fcd2ae317e21";
  const char *appSKey = "831caee08c9d143fb41c0189af32ab42";
...
void loop()
{
  ...
  long t = 0,calibrateddepth = 0, distance = 0, level=0;

  // Ultrasonic read login////////////////
  // Transmitting pulse
